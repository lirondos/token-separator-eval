...
echo SEED,PRECISION_ALL,RECALL_ALL,F1_ALL,PRECISION_ENG,RECALL_ENG,F1_ENG,PRECISION_OTHER,RECALL_OTHER,F1_OTHER > $CSV_SPAN_DEV
echo SEED,PRECISION_ALL,RECALL_ALL,F1_ALL,PRECISION_ENG,RECALL_ENG,F1_ENG,PRECISION_OTHER,RECALL_OTHER,F1_OTHER > $CSV_SPAN_TEST

export CSV_TS_DEV="$EVALUATION_DIR"/"$embedding"_ts_dev.csv
export CSV_TS_TEST="$EVALUATION_DIR"/"$embedding"_ts_test.csv
echo SEED,PRECISION_ALL,RECALL_ALL,F1_ALL,PRECISION_ENG,RECALL_ENG,F1_ENG,PRECISION_OTHER,RECALL_OTHER,F1_OTHER > $CSV_TS_DEV
echo SEED,PRECISION_ALL,RECALL_ALL,F1_ALL,PRECISION_ENG,RECALL_ENG,F1_ENG,PRECISION_OTHER,RECALL_OTHER,F1_OTHER > $CSV_TS_TEST
...
echo SEED,PRECISION_ALL,RECALL_ALL,F1_ALL,PRECISION_ENG,RECALL_ENG,F1_ENG,PRECISION_OTHER,RECALL_OTHER,F1_OTHER > $CSV_TS_TOK_DEV
echo SEED,PRECISION_ALL,RECALL_ALL,F1_ALL,PRECISION_ENG,RECALL_ENG,F1_ENG,PRECISION_OTHER,RECALL_OTHER,F1_OTHER > $CSV_TS_TOK_TEST
...
echo SEED,PRECISION_ENT,RECALL_ENT,F1_ENT> $CSV_SPAN_AGNOSTIC_DEV
echo SEED,PRECISION_ENT,RECALL_ENT,F1_ENT> $CSV_SPAN_AGNOSTIC_TEST
...
echo SEED,PRECISION_ENT,RECALL_ENT,F1_ENT> $CSV_TS_AGNOSTIC_DEV
echo SEED,PRECISION_ENT,RECALL_ENT,F1_ENT> $CSV_TS_AGNOSTIC_TEST
...
echo SEED,PRECISION_ENT,RECALL_ENT,F1_ENT> $CSV_TS_TOK_AGNOSTIC_DEV
echo SEED,PRECISION_ENT,RECALL_ENT,F1_ENT> $CSV_TS_TOK_AGNOSTIC_TEST
